...
Manual adjustment of non-deductible VAT credits. Posts a journal entry and adds a type-04 line to the fiscal book of the period.
...
*Accounting -> Reporting -> VAT Write Offs*: create the voucher, set accounts and amount, then post.
...
This module is part of the [OCA/l10n-venezuela](https://github.com/OCA/l10n-venezuela/tree/17.0/l10n_ve_vat_write_off) project on GitHub.
