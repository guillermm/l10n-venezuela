...
Vendor municipal withholding for Odoo 17. Uses the same municipalities as `territorial_pd`; the economic activity sets the rate. Applied on Register Payment (write-off). This is not IMI / patente municipal self-assessment.
...
Set the municipal withholding journal and account on the company, and the rate on each supplier.
...
This module is part of the [OCA/l10n-venezuela](https://github.com/OCA/l10n-venezuela/tree/17.0/l10n_ve_withholding_muni) project on GitHub.
