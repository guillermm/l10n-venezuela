...
Customs declarations DUA / DVI (Forma 86). Linked vendor bills become SENIAT document type 05 in the purchase book and IVA TXT (form number + expediente).
...
Create a DUA/DVI record and link it to the import vendor bill.
...
This module is part of the [OCA/l10n-venezuela](https://github.com/OCA/l10n-venezuela/tree/17.0/l10n_ve_imex) project on GitHub.
